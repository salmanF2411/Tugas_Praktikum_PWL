                ...
                <form method="post" action="{{ route('returns.store') }}" class="mt-6 space-y-6">
                    ...
                    <div class="max-w-xl">
                        ...
                        <x-select-input id="loan_detail_id" name="loan_detail_id" class="mt-1 block w-full" required>
                            ...
                            <option value="{{ $detail->id }}" @selected(old('loan_detail_id')==$detail->id)>
                    ...
                    <div class="max-w-xl">
                        ...
                        <x-select-input id="charge" name="charge" class="mt-1 block w-full" required>
                            ...
                            <option value="1" @selected(old('charge')==='1' )>Ya</option>
                            <option value="0" @selected(old('charge')==='0' )>Tidak</option>
                        </x-select-input>
                        <x-input-error class="mt-2" :messages="$errors->get('charge')" />
                    </div>
                    <div class="max-w-xl">
                        <x-input-label for="amount" value="Jumlah Biaya" />
                        <x-text-input id="amount" type="number" name="amount" class="mt-1 block w-full" value="{{ old('amount') }}" required />
