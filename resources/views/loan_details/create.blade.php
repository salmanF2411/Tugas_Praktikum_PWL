    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="post" action="{{ route('loan.details.store') }}" class="mt-6 space-y-6">
                    @csrf
                    <div class="max-w-xl">
                    ...
                    <div class="max-w-xl">
                        ...
                        <x-select-input id="is_return" name="is_return" class="mt-1 block w-full" required>
                            ...
                            <option value="1" @selected(old('is_return')==='1' )>Sudah</option>
                            <option value="0" @selected(old('is_return')==='0' )>Belum</option>
                        </x-select-input>
